module SimpleTokenAuthentication
  module TokenAuthenticationHandler
    ...
    included do
      cattr_writer :handled_token_authenticatables
      private_class_method :define_token_authentication_helpers_for
      private_class_method :handled_token_authenticatables=
      private_class_method :set_authentication_hooks
    end
    ...
    module ClassMethods
      ...
      #
      # Returns the Array of the handled token authenticatable Classes.
      def handle_token_authentication_for(model, options = {})
        ...
        set_authentication_hooks(entity, options)

        entity
      end

      # Returns the Array of the handled token authenticatable Classes.
      def handled_token_authenticatables
        unless class_variable_get(:@@handled_token_authenticatables)
          class_variable_set(:@@handled_token_authenticatables, [])
        end
        class_variable_get(:@@handled_token_authenticatables)
      end
      ...
      def set_authentication_hooks(entity, options)
